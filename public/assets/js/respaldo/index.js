$(document).ready(function () {
  ...
  $("body").on("click", "#respaldar", async function (e) {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (response.success) {
              ...
              Swal.fire("Incorrecto!", "Contraseña incorrecta", "warning");
              $("#respaldar").click();
    ...
    $(
      ".swal2-content"
    ).append(`<span class="text-center spanRespaldar">Nota: Se creará un archivo de respaldo, solo puede haber un máximo de 10 archivos. 
  ...
  $("body").on("click", "#restaurar", async function (e) {
    ...
    $("#formularioRestaurar").submit(function (e) {
      ...
      $(
        ".swal2-content"
      ).append(`<span class="text-center spanRespaldar">Nota: Al restaurar la 
