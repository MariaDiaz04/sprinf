...
SELECT malla_curricular.materia_id,malla_curricular.codigo,materias.nombre, trayecto.nombre as nombre_trayecto, trayecto.codigo as codigo_trayecto, fase.nombre as nombre_fase, fase.codigo as codigo_fase, count(dimension.id) as dimensiones_proyecto
FROM materias
