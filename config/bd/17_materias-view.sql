...
SELECT malla_curricular.codigo,materias.nombre, trayecto.nombre as nombre_trayecto, fase.nombre as nombre_fase, count(dimension.id) as dimensiones_proyecto
FROM materias
