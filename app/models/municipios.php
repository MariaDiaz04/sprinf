...
class municipio extends model
{
  ...
  public function save($id = null)
  {
    ...
    $query = $this->prepare("INSERT INTO municipios(nombre) VALUES (:nombre)");
    ...
    if ($query->execute()) {
      ...
      throw new Exception('Error insertando municipio');
    }
  }

  public function actualizar()
  {
    $preparedSql = "UPDATE municipios SET nombre=:nombre, municipio=:municipio WHERE id=:id";
  ...
  public function all()
  {
    $proyectos = $this->select("detalles_municipio");
  ...
  {
    $query = $this->prepare("SELECT * FROM detalles_municipio WHERE parroqua_id = :id");
