...
/*$consulta = "SELECT persona.*, usuarios.email,cliente_comprador.* FROM `usuarios` INNER JOIN persona on usuarios.id=persona.usuarios_id and persona.rol_id = 5 INNER JOIN cliente_comprador on cliente_comprador.persona_id=persona.id";
