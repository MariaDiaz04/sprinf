                        ...
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="../assets/img/icons/unicons/usuario-verificado.png" alt="chart success" class="rounded">
                            </div>
                            <!-- <div class="dropdown">
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img src="../assets/img/icons/unicons/bloquear-usuario.png" alt="Credit Card" class="rounded">
                            </div>
                   <!--          <div class="dropdown">
